...
from PetClinicAPI.apps.clinic.serializers import (
    DrugSerializer,
    AppointmentSerializer,
    AvaliationSerializer,
)
from PetClinicAPI.resources.permissions import (
    IsVetOrAdminOrReadOnly,
    IsVeterinartOrIsAuthenticatedReadOnly,
)
